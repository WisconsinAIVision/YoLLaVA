...
def eval_model(args):
    ...
    # sks_token = torch.load('/nobackup2/thao-data/yourLLaVA/checkpoints/mam/final/best-token.pt').detach()
    # lm_head = torch.load(f'/nobackup2/thao-data/yourLLaVA/checkpoints/mam/final/best-lmhead.pt', map_location=model.lm_head.weight.device).detach()
    ...
    #     # breakpoint()
    #     questions[index]['text'] = sks_prompt + ' ' + questions[index]['text']
    # breakpoint()
